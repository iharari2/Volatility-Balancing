...
class TestOrdersAPI:
    ...
    def test_submit_order_negative_quantity(self, client, tenant_id):
        ...
        response = client.post(
            f"/v1/tenants/{tenant_id}/portfolios/{portfolio_id}/positions/{pos_id}/orders",
            json={"side": "BUY", "qty": -10.0},
        )
    ...
    def test_list_orders_with_limit(self, client, tenant_id, portfolio_id, position_id):
        ...
        response = client.get(
            f"/v1/tenants/{tenant_id}/portfolios/{portfolio_id}/positions/{position_id}/orders?limit=50"
        )
    ...
    def test_list_orders_position_not_found(self, client, tenant_id, portfolio_id):
        ...
        response = client.get(
            f"/v1/tenants/{tenant_id}/portfolios/{portfolio_id}/positions/non_existent_id/orders"
        )
