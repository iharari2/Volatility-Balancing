...
from application.dto.orders import CreateOrderRequest, CreateOrderResponse, FillOrderRequest, FillOrderResponse
...
def submit_order(
    ...
    try:
        created, replay = uc.execute(position_id=position_id, request=payload, idempotency_key=idempotency_key)
